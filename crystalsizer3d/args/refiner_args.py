...
class RefinerArgs(BaseArgs):
    def __init__(
        ...
        self.rcf_model_path = None  # rcf_model_path
    ...
    def add_args(cls, parser: ArgumentParser) -> _ArgumentGroup:
        ...
        group.add_argument('--denoiser-n-tiles', type=int, default=4,
        ...
        group.add_argument('--denoiser-batch-size', type=int, default=4,
        ...
        group.add_argument('--initial-pred-batch-size', type=int, default=16,
        ...
        group.add_argument('--initial-pred-noise-max', type=float, default=0.2,
        ...
        group.add_argument('--spp', type=int, default=64,
        ...
        group.add_argument('--superres-n-patches', type=int, default=2,
                           help='Number of patches to use for superresolution.')
        group.add_argument('--superres-patch-size', type=int, default=32,
        ...
        group.add_argument('--opt-algorithm', type=str, default='adam',
        ...
        group.add_argument('--distances-noise', type=float, default=0.01,
                           help='Standard deviation of the noise to add to the distances.')
        group.add_argument('--rotation-noise', type=float, default=0.02,
        ...
        group.add_argument('--lr-distances', type=float, default=1e-2,
                           help='Learning rate for the distances.')
        group.add_argument('--lr-origin', type=float, default=1e-2,
                           help='Learning rate for the origin.')
        group.add_argument('--lr-rotation', type=float, default=1e-2,
        ...
        group.add_argument('--lr-light', type=float, default=1e-2,
                           help='Learning rate for the light.')

        # Learning rate scheduler
        group.add_argument('--lr-scheduler', type=str, default='cosine',
                           help='Learning rate scheduler.')
        group.add_argument('--lr-min', type=float, default=1e-2,
                           help='Minimum learning rate.')
        group.add_argument('--lr-warmup', type=float, default=1e-3,
                           help='Warmup learning rate.')
        group.add_argument('--lr-warmup-steps', type=int, default=20,
        ...
        group.add_argument('--w-perceptual', type=float, default=1e-3,
                           help='Weight of the perceptual loss.')
        group.add_argument('--w-latent', type=float, default=1e-2,
