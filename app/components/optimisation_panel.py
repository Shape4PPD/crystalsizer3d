...
class OptimisationPanel(AppPanel):
    ...
    def _init_components(self):
        ...
        self.anchors_list.SetColumnWidth(col=1, width=int(self.anchors_list.GetSize()[0] / 3))
        self.anchors_list.InsertColumn(2, '2D Coordinate')
        self.anchors_list.SetColumnWidth(col=2, width=int(self.anchors_list.GetSize()[0] / 3))
